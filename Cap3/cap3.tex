...
O sistema modela um veículo se movendo em um plano 2D, onde consideramos sua posição e velocidade nas direções longitudinal (x) e lateral (y), conforme Equação \ref{eq:manobra-mudanca-faixa}.
